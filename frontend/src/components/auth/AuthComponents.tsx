...
export const AuthCard: React.FC<{ children: React.ReactNode; title: string; subtitle?: string }> = ({
  ...
  return (
    <Card className="glass-panel border-white/10 shadow-2xl relative overflow-hidden p-8">
      {/* Small glow decorative dots */}
      <div className="absolute top-[-20%] right-[-20%] w-32 h-32 bg-violet-600/20 blur-2xl rounded-full" />
      <div className="absolute bottom-[-20%] left-[-20%] w-32 h-32 bg-cyan-400/10 blur-2xl rounded-full" />
      
      <div className="text-center mb-6 relative z-10">
        <h2 className="text-2xl font-display font-extrabold text-white tracking-wide">{title}</h2>
      ...
      <div className="flex flex-col gap-1.5 w-full">
        ...
        <div className="relative">
          ...
          <input
            ref={ref}
            type={type}
            className={`w-full ${icon ? 'pl-10' : 'px-4'} pr-4 py-2.5 text-sm glass-input text-white ${
              error ? 'border-red-500/50 focus:border-red-500 focus:shadow-[0_0_12px_rgba(239,68,68,0.25)]' : ''
            } ${className}`}
            {...props}
          />
        </div>
      ...
      <div className="flex flex-col gap-1.5 w-full">
        ...
        <div className="relative">
          <input
            ...
            className={`w-full px-4 pr-10 py-2.5 text-sm glass-input text-white ${
              error ? 'border-red-500/50 focus:border-red-500 focus:shadow-[0_0_12px_rgba(239,68,68,0.25)]' : ''
            } ${className}`}
            {...props}
          />
  ...
  return (
    <div className="w-full space-y-3">
      <Button
        ...
        className="w-full justify-center py-2.5 rounded-xl flex items-center gap-3 border border-white/5 hover:bg-white/5"
      >
      ...
      <Button
        ...
        className="w-full justify-center py-2.5 rounded-xl flex items-center gap-3 border border-white/5 hover:bg-white/5 text-slate-300"
      >
